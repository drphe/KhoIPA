...
Trên KhoIPA có ứng dụng <a href="#" data-bundleid="com.tijo.opener.Opener%40repo.drphe.kh0ipa" class="app-header-link"> Opener </a>, cài ứng dụng này từ file IPA (nếu ko phải mua trên store).
...
* Bước 3: Vào Cài đặt của iPhone/iPad -> Safari -> Phần mở rộng -> bật cái Userscripts lên.
* Bước 4: Mở link sau bằng trình duyệt safari (tùy vào bạn muốn sử dụng cho ứng dụng nào thì bấm vào liên kết đó).

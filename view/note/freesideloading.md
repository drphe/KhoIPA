...
Nếu bạn muốn học cách **ký ứng dụng (sign apps)** hoặc **thêm repo**, hãy xem phần bên dưới!  

---
Đây là bản dịch sang tiếng Việt cho phần **Best Guide** bạn đưa:  

---

## Hướng dẫn tốt nhất  
**Bước 1: Tạo DNS của riêng bạn**  *(Đã bỏ DNS dựng sẵn)*  

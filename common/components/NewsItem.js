...
<div class="swiper-slide news-item-wrapper"> ${news.url ?
	...
	${minimal ?'<div class="text" style="position: relative;"></div>':''}
        <div class="text" style="${minimal ?'height: 100%;margin: 0em;background: linear-gradient(to top, var(--color-transparent-dark) 60%, rgba(0, 0, 0, 0));padding: 1em;border-radius: 10px;':'height:5.5rem;'}">

...
<div class="news-item-wrapper"> ${news.url ?
	...
	${minimal ?'<div class="text" style="position: relative;"></div>':''}
        <div class="text" style="${minimal ?'margin: 0em;background: linear-gradient(to top, #'+news.tintColor.replaceAll("#", "") +' 70%, rgba(0, 0, 0, 0));padding: 1em;border-radius: 10px;margin-bottom: -1rem;':''}">
